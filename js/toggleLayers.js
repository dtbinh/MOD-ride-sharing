L.mapbox.accessToken = 'pk.eyJ1IjoiZGhlY2h0IiwiYSI6ImNqNHRueTVyeDA3ZmYyd3FuY2NmYW9tNmoifQ.FetU2-IBDcrhTmSKBpFIfA';
     ...
     addLayer(L.mapbox.tileLayer('https://api.mapbox.com/v1/mapbox.traffic-day-v2.json'), 'Traffic Day',1); //traffic-night-v2
     addLayer(L.mapbox.tileLayer('https://api.mapbox.com/v1/mapbox.traffic-night-v2.json'), 'Traffic Night',2); //traffic-night-v2
